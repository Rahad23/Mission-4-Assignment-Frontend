  ...
  return (
    <div className="lg:px-24 px-7">
      <div className="mt-16 leading-7 font-semibold lg:text-left text-center ">
        <span className="text-gray-950">Dear Customer,</span> Welcome to
        Eco-Shop Ecommerce Market Place. Eco-Shop is a very popular platform in
        Bangladesh in the list of sell online product. We have been providing
        essential product since 2024. Each of our customers is added to a
        private group for any after-sales support to resolve their issues. So
        every customer will get instant solutions for any after-sale problem. If
        you need any assistance feel free to ask any question via{" "}
        <a
